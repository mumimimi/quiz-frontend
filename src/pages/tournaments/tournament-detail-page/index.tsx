    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-4xl mx-auto flex flex-col gap-6">
        ...
        <div className="bg-[#181818] border border-[#1d1d1d] rounded-2xl p-5 flex flex-col gap-4">
          ...
          {tournament.rules && (
            <div>
              <span className="text-xs text-[#555] uppercase tracking-wider">Rules</span>
          ...
          <div className="grid grid-cols-2 gap-4 pt-2 border-t border-[#1d1d1d]">
            ...
            {tournament.endDate && (
              <div>
                <span className="text-xs text-[#555]">End date</span>
                <p className="text-[#aaa] text-sm mt-0.5">
        ...
        <div>
          <h2 className="text-white font-medium mb-3">Rounds</h2>
                ...
                >
                  <div className="flex flex-col gap-0.5 min-w-0">
                    ...
                    <span className="text-[#555] text-xs">
                      Deadline: {dayjs(round.submissionDeadline).format('DD MMM YYYY, HH:mm')}
                    </span>
                  </div>
