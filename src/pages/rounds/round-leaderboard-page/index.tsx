...
import { useRoundLeaderboardPage } from './use-round-leaderboard-page'
...
const RoundLeaderboardPage = (): JSX.Element => {
  const { entries, isLoading, isError, handleBack } = useRoundLeaderboardPage()
    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-5xl mx-auto flex flex-col gap-6">
        <div>
          ...
          >
            <IoArrowBack size={16} />
            {t('leaderboard.roundBack')}
          </button>
          <h1 className="text-white text-2xl font-semibold">{t('leaderboard.roundTitle')}</h1>
...
export default RoundLeaderboardPage
